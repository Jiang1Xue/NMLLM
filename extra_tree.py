...
def main():
    ...
    for train_index, test_index in ss.split(isoform_express_scaled_state, sample_label_state):
        ...
        clf = ExtraTreesClassifier(n_estimators=isoform_express_scaled.shape[-1], max_depth=None, min_samples_split=2, random_state=0)
    ...
    predict_label_s = predict_label_s.flatten()
    ...
    predict_label_c = np.array(predict_label_c).flatten()
    ...
    cost_df.to_csv('/Users/xuejiang/PycharmProjects/isofom_/result/extratree/6/time_cost.csv')

    label_all_s_df = pd.DataFrame(data=label_all_s)
    label_all_c_df = pd.DataFrame(data=label_all_c)

    label_all_s_df.to_csv('/Users/xuejiang/PycharmProjects/isofom_/result/extratree/6/label_all_s.csv')
    label_all_c_df.to_csv('/Users/xuejiang/PycharmProjects/isofom_/result/extratree/6/label_all_c.csv')
