...
def main():
    ...
    for train_index, test_index in ss.split(isoform_express_scaled_state, sample_label_state):
        ...
        clf = RandomForestClassifier(n_estimators=isoform_express_scaled.shape[-1], max_depth=None, min_samples_split=2, random_state=0)
    ...
    cost_df.to_csv('/Users/xuejiang/PycharmProjects/isofom_/result/rf/4/time_cost.csv')

    label_all_s_df = pd.DataFrame(data=label_all_s)
    label_all_c_df = pd.DataFrame(data=label_all_c)

    label_all_s_df.to_csv('/Users/xuejiang/PycharmProjects/isofom_/result/rf/4/label_all_s.csv')
    label_all_c_df.to_csv('/Users/xuejiang/PycharmProjects/isofom_/result/rf/4/label_all_c.csv')
